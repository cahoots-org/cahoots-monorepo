...
@pytest.fixture
async def trello_service():
    """Create mock Trello service."""
    mock_service = AsyncMock()
    mock_service.check_connection = AsyncMock(return_value=True)
    mock_service.create_board = AsyncMock(return_value={"id": "test_board"})
    mock_service.create_list = AsyncMock(return_value={"id": "test_list"})
    mock_service.create_card = AsyncMock(return_value={"id": "test_card"})
