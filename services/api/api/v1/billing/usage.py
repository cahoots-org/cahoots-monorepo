...
from schemas.billing import UsageDetailResponse, UsageResponse, UsageSummaryResponse
...
async def get_usage_details(
    ...
    try:
        ...
        details = await service.get_usage_details(
            current_user.id, start_date=start_date, end_date=end_date, service_type=service_type
        )
...
async def get_usage_limits(
    ...
    try:
        ...
        return APIResponse(success=True, data=limits)
    except Exception as e:
        return APIResponse(
            success=False,
            error=ErrorDetail(
