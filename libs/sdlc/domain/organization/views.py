    ...
    def apply_event(self, event):
        ...
        if isinstance(event, OrganizationCreated):
            entry = OrganizationAuditLogEntry(
                ...
                user_id=event.created_by,
                details={"name": event.name, "description": event.description},
            )
            ...
            entry = OrganizationAuditLogEntry(
                ...
                details={"added_user_id": event.user_id, "role": event.role},
            )
            ...
            entry = OrganizationAuditLogEntry(
                ...
                details={"removed_user_id": event.user_id, "reason": event.reason},
            )
