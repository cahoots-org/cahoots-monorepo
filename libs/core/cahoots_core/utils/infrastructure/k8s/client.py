...
class KubernetesClient:
    ...
    async def get_deployment_status(
        ...
        try:
            deployment = self.apps_v1.read_namespaced_deployment(
                name=deployment_name, namespace=namespace or self.namespace
            )
    ...
    async def list_pods(
        ...
        try:
            pods = self.core_v1.list_namespaced_pod(
                namespace=namespace or self.namespace, label_selector=label_selector
            )
    ...
    async def create_job(
        ...
        try:
            ...
            # Create the job
            self.batch_v1.create_namespaced_job(namespace=namespace or self.namespace, body=job)
    ...
    async def delete_job(self, name: str, namespace: Optional[str] = None) -> bool:
