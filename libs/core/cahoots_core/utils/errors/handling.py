...
class ErrorHandler:
    ...
    def __init__(self, service_name: str, logger: Optional[logging.Logger] = None):
        ...
        self._recovery_handlers: Dict[
            RecoveryStrategy, List[Callable[[SystemError], Optional[Any]]]
        ] = {}
        self._circuit_breakers: Dict[str, bool] = {}

    def handle_error(
        self, error: SystemError, correlation_id: Optional[UUID] = None, **context_data
    ) -> Optional[Any]:
    ...
    def register_error_handler(
        self, category: ErrorCategory, handler: Callable[[SystemError], None]
    ):
    ...
    def register_recovery_handler(
        self, strategy: RecoveryStrategy, handler: Callable[[SystemError], Optional[Any]]
    ):
...
def with_error_handling(
    category: ErrorCategory, severity: ErrorSeverity, recovery_strategy: RecoveryStrategy
):
        ...
        async def wrapper(self, *args, **kwargs):
            try:
                ...
                if isinstance(e, SystemError):
                    ...
                    error = SystemError(
                        str(e), category, severity, recovery_strategy, original_error=e
                    )
