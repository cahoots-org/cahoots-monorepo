...
class ProposeCodeChange:
    def __init__(self, command_id, correlation_id, project_id, files, description, reasoning, proposed_by):
...
class ReviewCodeChange:
    def __init__(self, command_id, correlation_id, project_id, change_id, status, comments, suggested_changes, reviewed_by):
        self.command_id = command_id
        self.correlation_id = correlation_id
        self.project_id = project_id
