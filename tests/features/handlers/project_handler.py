...
class RequirementAdded:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, requirement_id, title, description, priority, dependencies, added_by):
...
class TaskCreated:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, requirement_id, task_id, title, description, complexity, created_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class TaskCompleted:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, requirement_id, task_id, completed_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class ProjectTimelineSet:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, start_date, target_date, milestones, set_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class RequirementBlocked:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, requirement_id, blocker_description, blocked_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class RequirementUnblocked:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, requirement_id, resolution, unblocked_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class RequirementPriorityChanged:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, requirement_id, new_priority, reason, changed_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class TaskAssigned:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, task_id, requirement_id, assignee_id, assigned_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class TaskBlocked:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, task_id, requirement_id, blocker_description, blocked_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class TaskUnblocked:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, task_id, requirement_id, resolution, unblocked_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class TaskPriorityChanged:
    ...
    def __init__(self, event_id, timestamp, metadata, project_id, task_id, requirement_id, new_priority, reason, changed_by):
        self.event_id = event_id
        self.timestamp = timestamp
        self.metadata = metadata
        self.project_id = project_id
...
class ProjectHandler:
    ...
    def handle_add_requirement(self, cmd):
        ...
        overview_view = self.view_store.get_view(
            cmd.project_id,
            ProjectOverviewView
        )
        requirements_view = self.view_store.get_view(
            cmd.project_id,
            RequirementsView
        )
    ...
    def handle_create_task(self, cmd):
        ...
        # Import the view classes here to avoid circular imports
        from ..views.project_views import ProjectOverviewView, RequirementsView, TaskBoardView
        ...
        task_board_view = self.view_store.get_view(
            cmd.project_id,
            TaskBoardView
        )
    ...
    def handle_update_status(self, cmd):
        ...
        if cmd.status == 'completed':
            active_requirements = [req for req in requirements_view.requirements.values() if req['status'] == 'active']
