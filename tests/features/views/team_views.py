...
class TeamView:
    ...
    def apply_event(self, event):
        ...
        if event_type == "TeamCreated":
            ...
            self.created_at = event.metadata.created_at if hasattr(event, 'metadata') else event.timestamp
            ...
            self.archived_at = event.metadata.created_at if hasattr(event, 'metadata') else event.timestamp
