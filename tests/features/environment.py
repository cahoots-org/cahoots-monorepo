...
from tests.features.test_imports import CommandBus as TestCommandBus, CreateSystemUser as TestCreateSystemUser, handle_create_system_user
from tests.features.infrastructure.event_store import InMemoryEventStore, InMemoryViewStore
...
from cahoots_events.system_commands import CreateSystemUser, handle_create_system_user as cahoots_handle_create_system_user
...
from tests.features.handlers.organization_repository import EventStoreOrganizationRepository


def before_all(context):
    """Set up test environment before all tests"""
    # Register command handlers
    from tests.features.test_imports import CreateSystemUser as TestCreateSystemUser, handle_create_system_user
    from cahoots_events.system_commands import CreateSystemUser, handle_create_system_user as cahoots_handle_create_system_user
