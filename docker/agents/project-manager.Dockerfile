...
LABEL org.opencontainers.image.title="AI Dev Team - project-manager Agent" \
      org.opencontainers.image.description="Project manager agent for coordinating tasks and resources" \
      org.opencontainers.image.source="https://github.com/your-org/ai-dev-team"

# Environment variables for agent configuration
ENV AGENT_NAME=project-manager \
...
COPY --chown=app:app config/agents/project-manager.yaml /app/config/agent.yaml
