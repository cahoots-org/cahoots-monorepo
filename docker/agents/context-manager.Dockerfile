...
LABEL org.opencontainers.image.title="AI Dev Team - context-manager Agent" \
      org.opencontainers.image.description="Context manager agent for maintaining project context and knowledge" \
      org.opencontainers.image.source="https://github.com/your-org/ai-dev-team"

# Environment variables for agent configuration
ENV AGENT_NAME=context-manager \
    AGENT_ROLE=context-manager \
...
COPY --chown=app:app config/agents/context-manager.yaml /app/config/agent.yaml
