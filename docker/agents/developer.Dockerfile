...
LABEL org.opencontainers.image.title="AI Dev Team - developer Agent" \
      org.opencontainers.image.description="Developer agent for handling development tasks" \
...
COPY --chown=app:app config/agents/developer.yaml /app/config/agent.yaml
