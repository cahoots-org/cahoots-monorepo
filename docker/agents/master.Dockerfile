...
LABEL org.opencontainers.image.title="AI Dev Team - master Agent" \
      org.opencontainers.image.description="Master agent for coordinating other agents" \
      org.opencontainers.image.source="https://github.com/your-org/ai-dev-team"

# Environment variables for agent configuration
ENV AGENT_NAME=master \
    AGENT_ROLE=master \
...
COPY --chown=app:app config/agents/master.yaml /app/config/agent.yaml
