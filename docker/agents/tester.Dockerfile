...
LABEL org.opencontainers.image.title="AI Dev Team - tester Agent" \
      org.opencontainers.image.description="Tester agent for quality assurance and testing" \
      org.opencontainers.image.source="https://github.com/your-org/ai-dev-team"

# Environment variables for agent configuration
ENV AGENT_NAME=tester \
    AGENT_ROLE=tester \
...
COPY --chown=app:app config/agents/tester.yaml /app/config/agent.yaml
